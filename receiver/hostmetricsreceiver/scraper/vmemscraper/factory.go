...
// This file implements Factory for VMem scraper.
...
func (f *Factory) CreateMetricsScraper(
	...
	if runtime.GOOS != "windows" {
		return nil, errors.New("vmem scraper is currently only supported on windows")
	}

	cfg := config.(*Config)

	return NewVMemScraper(ctx, cfg, consumer)
}
