...
func TestLoadConfig(t *testing.T) {
	...
	collectorFactories, err := component.MakeScraperFactoryMap(
		&cpuscraper.Factory{},
	)
	require.NoError(t, err)
	...
	defaultConfigAllScrapers.(*Config).Scrapers = map[string]component.ScraperConfig{
		cpuscraper.TypeStr: collectorFactories[cpuscraper.TypeStr].CreateDefaultConfig(),
	}
